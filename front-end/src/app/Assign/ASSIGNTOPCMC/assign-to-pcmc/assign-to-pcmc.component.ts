...
@Component({
  ...
  templateUrl: './assign-to-pcmc.component.html',
  styleUrls: ['./assign-to-pcmc.component.css']
})
export class AssignToPcmcComponent implements OnInit {
  ...
  constructor(private route: ActivatedRoute,
    ...
    reloadData() {
      this.approvelService.getUserSuperPCMCVList().subscribe(
        data => {
          this.userMsts = data;
          setTimeout(function () {
